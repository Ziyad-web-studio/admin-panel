...
export default function Home() {
  return (
    <main>
      <Container className="flex min-h-screen flex-col items-center justify-center py-48 md:py-64">
        <div className="grid w-full grid-cols-1 gap-48 lg:grid-cols-2 lg:gap-64">
          ...
          <div className="flex flex-col justify-center items-start gap-24 order-2 lg:col-start-1 lg:row-start-1 lg:row-span-2 self-center text-left">
            ...
            <div className="flex flex-col gap-16 sm:flex-row w-full sm:w-auto">
              <a
                href="/projects"
                className="inline-flex items-center justify-center rounded bg-accent px-32 py-16 text-body font-medium text-primary shadow-1 transition-opacity hover:opacity-90 w-full sm:w-auto"
              >
                View Projects
              </a>
              <a
                href="/contact"
                className="inline-flex items-center justify-center rounded border border-border bg-transparent px-32 py-16 text-body font-medium text-primary transition-colors hover:border-accent/50 hover:bg-surface w-full sm:w-auto"
              >
                Contact Me
              </a>
            </div>
